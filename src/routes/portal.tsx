        ...
        <section className="portal-body-card portal-landing-card">
          <div className="portal-landing-copy">
            ...
            <div className="portal-card" style={{ marginTop: '18px', padding: '16px', border: '1px solid rgba(76, 211, 209, 0.24)' }}>
              ...
              <p className="portal-muted" style={{ marginBottom: '12px' }}>Η πρόσβαση είναι διαθέσιμη μόνο για τον κύριο διαχειριστή του Glowworks portal.</p>
              ...
              <div className="portal-actions" style={{ marginTop: '14px' }}>
                <button className="button button-primary" type="button" onClick={continueAsAdmin}>
          ...
          <div className="portal-card portal-highlight-card">
            ...
            <p>{role ? `Συνδεδεμένος ως admin για ${adminEmail}.` : 'Εισέλθε ως διαχειριστής για να συνεχίσεις.'}</p>
            ...
            <div className="portal-actions" style={{ marginTop: '12px' }}>
              <Link className="button button-primary" to="/portal/admin">Άνοιγμα admin portal</Link>
            </div>
          </div>
        </section>
      </div>
